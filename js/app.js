...
var questions;
var correct = 0;
for (questions = 1; questions < 6; questions++) {
    switch (questions) {
        case 1:
            ...
            console.log('This question is designed for tea lovers ' + userName + ' answered ' + answerOne);
            break;
        case 2:
            var answerTwo = prompt('Are dogs the first animal to be domesticated by humans?').toLowerCase();
            ...
            console.log('This question is designed for animal lovers ' + userName + ' answered ' + answerTwo);
            break;
        case 3:
            ...
            console.log('This question is designed for sushi lovers ' + userName + ' answered ' + answerThree);
            break;
        case 4:
        ...
        case 5:
            ...
            console.log('This question is designed for bubble tea lovers ' + userName + ' answered ' + answerFive);
            break;
